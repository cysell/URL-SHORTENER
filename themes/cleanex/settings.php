  	...
  	<?php echo $this->sidebar() ?>	
		...
		<?php if($this->config["allowdelete"]): ?>
			<div class="panel panel-default panel-body">
				...
				<p><a href="" class="btn btn-danger btn-round ajax_call" data-action="delete_account" data-title="<?php echo e("Delete your account") ?>"><?php echo e("Delete permanently") ?></a></p>
			</div>
		<?php endif ?>  			
  </div><!--/#widgets-->
</div><!--/.row-->