  ...
  <body>
  	<div class="container">
  		<div class="left">
			...
			<p>
				<a href="https://www.domain.com/" target="_blank">主页</a> | 
				<a href="https://www.domain.com/" target="_blank">帮助</a> | 
				<a href="https://www.domain.com/" target="_blank">更新</a> <br />
				2012-<?php echo date("Y") ?> &copy; <a href="https://www.domain.com" target="_blank">某某</a> - All Rights Reserved
			</p>
  		</div>
  		<div class="right">
					<h1>某某短网址系统安装</h1> 
					...
					<?php if($step=="1"): ?>		
						<h2>1.0 服务器环境测试</h2>
						<p>
							某某短网址系统是一个专业的网址缩略的脚本代码，其主要功能有：完整的后台管理、功能齐全的用户面板、用户系统、社交分享、短网址统计、短网址自定义、多国语言支持、社交分享以及API系统等。
						</p>
						<div class="content">
							<p>
							PHP 版本 (最低需要php 5.5)
